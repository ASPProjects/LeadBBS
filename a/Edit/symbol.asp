...
<tr>
	...
	<tr>
		<td>āáǎàōóǒòēéěèīíǐìūúǔùǖǘǚǜüêɑńňǹɡ</td>
	</tr>
	</table>
...
<style>
.symbol{display:block;padding:3px;margin:1px;border-radius:3px;background:#ddd;float:left;font-size:16px;min-width:16px;text-align:center;}
</style>
<td width=50 valign=top>
<table border=0 cellpadding=0 cellspacing=0>
<tr><td align=right>
	<div class="layer_close"><a href="javascript:;" onclick="LD.hide('editor_symbol');return false;" class="unsel" hidefocus="true" title="close" /></a></div>
</td></tr>
<tr><td height=10></td></tr>
<tr><td align=center valign=middle style="font-size:32px;" class="bluefont" id=sym_preview align=center valign=middle width=50>
</td></tr>
<tr><td></td></tr>
</table>
</td></tr></table>