(function($){
   ...
   function creatColumn(){//创建列
      ...
      for(var i=0;i<waterfall.column_num;i++){
         ...
         html+='<div class="'+setting.column_className+'" style="width:'+setting.column_width+'px; display:inline-block; *display:inline;zoom:1; margin-left:0px;margin-right:'+setting.column_space+'px; vertical-align:top; "></div>';
   ...
   function calculateLowest(){//计算最短的那列的索引
      ...
      waterfall.$columns.each(function(i){                         
			//alert("$(this).outerHeight():"+$(this).outerHeight() + " -- min:" + min);
